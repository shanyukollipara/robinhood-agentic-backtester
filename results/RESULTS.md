...
Every strategy in [`examples/`](../examples) re-run against fresh market data on **2026-09-04 00:05 UTC**. Regenerated daily by [`.github/workflows/daily-backtest.yml`](../.github/workflows/daily-backtest.yml) - these numbers move because the market moved, not because anything was tuned.

| Strategy | Symbols | Since | Return | CAGR | Max DD | Worst month | Sharpe | Trades | Win rate | vs benchmark |
|---|---|---|---|---|---|---|---|---|---|---|
| [ATR Breakout](../examples/atr_breakout.yaml) | `QQQ` | 2012-01-03 | 57.90% | 3.16% | -7.58% | -2.34% | 0.75 | 67 | 50.7% | QQQ 1311.22% |
| [Golden Cross](../examples/golden_cross.yaml) | `SPY` | 2010-01-04 | 316.58% | 8.94% | -33.72% | -12.49% | 0.68 | 8 | 75.0% | SPY 804.67% |
| [Monthly Momentum](../examples/monthly_momentum.yaml) | `AAPL AMZN GOOGL META MSFT NVDA` | 2015-01-02 | 714.15% | 19.69% | -25.46% | -12.80% | 1.04 | 140 | 47.1% | SPY 350.92% |
| [RSI Dip Buyer](../examples/rsi_dip_buyer.yaml) | `IWM QQQ SPY` | 2012-01-03 | 40.34% | 2.34% | -17.90% | -7.97% | 0.45 | 369 | 71.0% | SPY 672.44% |
...
| 2026-05 | +5.26% | -1.93% | -1.93% | $41,100.45 |
| 2026-06 | -1.03% | -4.49% | -4.49% | $40,677.42 |
| 2026-07 | +0.03% | -3.38% | -3.72% | $40,691.58 |
| 2026-08 | +2.68% | -1.96% | -1.96% | $41,782.09 |
| 2026-09 | -0.30% | 0.00% | -2.07% | $41,658.30 |
...
| 2026-09 | +0.27% | 0.00% | -23.69% | $203,536.83 |

### RSI Dip Buyer

| Month | Return | Max DD in month | DD vs all-time high | End equity |
|---|---|---|---|---|
| 2026-04 | +0.57% | 0.00% | -1.00% | $13,829.03 |
| 2026-05 | +0.62% | -0.16% | -0.48% | $13,915.32 |
| 2026-06 | -0.19% | -1.96% | -2.12% | $13,888.22 |
| 2026-07 | +0.83% | -1.92% | -1.92% | $14,002.92 |
| 2026-08 | -0.06% | -0.67% | -0.80% | $13,994.04 |
| 2026-09 | +0.28% | 0.00% | -0.37% | $14,033.72 |
