...
Every strategy in [`examples/`](../examples) re-run against fresh market data on **2026-09-03 00:14 UTC**. Regenerated daily by [`.github/workflows/daily-backtest.yml`](../.github/workflows/daily-backtest.yml) - these numbers move because the market moved, not because anything was tuned.

| Strategy | Symbols | Since | Return | CAGR | Max DD | Worst month | Sharpe | Trades | Win rate | vs benchmark |
|---|---|---|---|---|---|---|---|---|---|---|
| [ATR Breakout](../examples/atr_breakout.yaml) | `QQQ` | 2012-01-03 | 56.32% | 3.09% | -8.51% | -2.34% | 0.74 | 68 | 50.0% | QQQ 1308.03% |
...
| 2026-09 | -0.74% | 0.00% | -2.12% | $41,474.31 |

### Monthly Momentum

| Month | Return | Max DD in month | DD vs all-time high | End equity |
|---|---|---|---|---|
| 2026-04 | +0.00% | 0.00% | -11.78% | $234,659.82 |
| 2026-05 | +2.69% | -1.91% | -11.92% | $240,972.79 |
| 2026-06 | -12.80% | -11.65% | -21.24% | $210,126.72 |
| 2026-07 | -2.64% | -6.89% | -23.08% | $204,582.10 |
| 2026-08 | -0.78% | -4.38% | -25.46% | $202,985.16 |
| 2026-09 | -0.07% | 0.00% | -23.74% | $202,848.06 |
...
| 2026-09 | -0.19% | 0.00% | -0.39% | $13,966.90 |
