...
Every strategy in [`examples/`](../examples) re-run against fresh market data on **2026-09-23 00:30 UTC**. Regenerated daily by [`.github/workflows/daily-backtest.yml`](../.github/workflows/daily-backtest.yml) - these numbers move because the market moved, not because anything was tuned.

| Strategy | Symbols | Since | Return | CAGR | Max DD | Worst month | Sharpe | Trades | Win rate | vs benchmark |
|---|---|---|---|---|---|---|---|---|---|---|
| [ATR Breakout](../examples/atr_breakout.yaml) | `QQQ` | 2012-01-03 | 57.90% | 3.15% | -7.58% | -2.34% | 0.75 | 67 | 50.7% | QQQ 1376.88% |
| [Golden Cross](../examples/golden_cross.yaml) | `SPY` | 2010-01-04 | 322.17% | 9.00% | -33.72% | -12.49% | 0.69 | 8 | 75.0% | SPY 816.81% |
| [Monthly Momentum](../examples/monthly_momentum.yaml) | `AAPL AMZN GOOGL META MSFT NVDA` | 2015-01-02 | 713.42% | 19.59% | -25.46% | -12.80% | 1.04 | 140 | 46.4% | SPY 356.97% |
| [RSI Dip Buyer](../examples/rsi_dip_buyer.yaml) | `IWM QQQ SPY` | 2012-01-03 | 39.72% | 2.30% | -17.90% | -7.97% | 0.44 | 372 | 70.7% | SPY 682.80% |
...
| 2026-09 | +1.04% | -2.47% | -3.06% | $42,216.97 |

### Monthly Momentum

| Month | Return | Max DD in month | DD vs all-time high | End equity |
|---|---|---|---|---|
| 2026-04 | +0.00% | 0.00% | -11.78% | $234,659.83 |
| 2026-05 | +2.69% | -1.91% | -11.92% | $240,972.80 |
| 2026-06 | -12.80% | -11.65% | -21.24% | $210,126.73 |
| 2026-07 | -2.64% | -6.89% | -23.08% | $204,582.10 |
| 2026-08 | -0.78% | -4.38% | -25.46% | $202,985.17 |
| 2026-09 | +0.18% | -3.10% | -24.50% | $203,355.72 |
...
| 2026-09 | -0.16% | -1.77% | -1.77% | $13,971.69 |
