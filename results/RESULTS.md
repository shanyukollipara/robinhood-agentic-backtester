...
Every strategy in [`examples/`](../examples) re-run against fresh market data on **2026-09-14 00:09 UTC**. Regenerated daily by [`.github/workflows/daily-backtest.yml`](../.github/workflows/daily-backtest.yml) - these numbers move because the market moved, not because anything was tuned.

| Strategy | Symbols | Since | Return | CAGR | Max DD | Worst month | Sharpe | Trades | Win rate | vs benchmark |
|---|---|---|---|---|---|---|---|---|---|---|
| [ATR Breakout](../examples/atr_breakout.yaml) | `QQQ` | 2012-01-03 | 56.32% | 3.09% | -8.51% | -2.34% | 0.74 | 68 | 50.0% | QQQ 1322.44% |
...
| 2026-09 | -0.41% | -1.98% | -2.58% | $41,610.97 |
...
| 2026-08 | -0.78% | -4.38% | -25.46% | $202,985.30 |
| 2026-09 | -0.19% | -3.10% | -24.50% | $202,598.93 |
...
| 2026-05 | +0.62% | -0.16% | -0.48% | $13,915.38 |
| 2026-06 | -0.19% | -1.96% | -2.12% | $13,888.28 |
| 2026-07 | +0.83% | -1.92% | -1.92% | $14,002.98 |
| 2026-08 | -0.06% | -0.67% | -0.80% | $13,994.10 |
| 2026-09 | +0.18% | -0.62% | -0.62% | $14,019.57 |
