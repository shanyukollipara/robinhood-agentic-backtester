...
Every strategy in [`examples/`](../examples) re-run against fresh market data on **2026-09-16 00:17 UTC**. Regenerated daily by [`.github/workflows/daily-backtest.yml`](../.github/workflows/daily-backtest.yml) - these numbers move because the market moved, not because anything was tuned.

| Strategy | Symbols | Since | Return | CAGR | Max DD | Worst month | Sharpe | Trades | Win rate | vs benchmark |
|---|---|---|---|---|---|---|---|---|---|---|
| [ATR Breakout](../examples/atr_breakout.yaml) | `QQQ` | 2012-01-03 | 57.90% | 3.16% | -7.58% | -2.34% | 0.75 | 67 | 50.7% | QQQ 1311.10% |
| [Golden Cross](../examples/golden_cross.yaml) | `SPY` | 2010-01-04 | 314.25% | 8.89% | -33.72% | -12.49% | 0.68 | 8 | 75.0% | SPY 799.61% |
| [Monthly Momentum](../examples/monthly_momentum.yaml) | `AAPL AMZN GOOGL META MSFT NVDA` | 2015-01-02 | 708.70% | 19.56% | -25.46% | -12.80% | 1.04 | 140 | 46.4% | SPY 348.40% |
| [RSI Dip Buyer](../examples/rsi_dip_buyer.yaml) | `IWM QQQ SPY` | 2012-01-03 | 39.34% | 2.28% | -17.90% | -7.97% | 0.44 | 372 | 70.4% | SPY 668.12% |
...
| 2026-09 | -0.85% | -1.98% | -2.58% | $41,425.31 |
...
| 2026-08 | -0.06% | -0.67% | -0.80% | $13,994.08 |
| 2026-09 | -0.43% | -1.22% | -1.22% | $13,934.00 |
