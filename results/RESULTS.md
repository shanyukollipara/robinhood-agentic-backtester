...
Every strategy in [`examples/`](../examples) re-run against fresh market data on **2026-08-27 05:32 UTC**. Regenerated daily by [`.github/workflows/daily-backtest.yml`](../.github/workflows/daily-backtest.yml) - these numbers move because the market moved, not because anything was tuned.
...
|---|---|---|---|---|
| 2026-03 | +0.00% | 0.00% | -4.43% | $30,313.30 |
...
| Month | Return | Max DD in month | DD vs all-time high | End equity |
|---|---|---|---|---|
| 2026-03 | -4.94% | -7.68% | -10.96% | $35,333.77 |
...
| 2026-08 | +2.50% | -1.96% | -1.96% | $41,708.43 |

### Monthly Momentum

| Month | Return | Max DD in month | DD vs all-time high | End equity |
|---|---|---|---|---|
| 2026-03 | -1.49% | -1.01% | -11.78% | $234,659.80 |
...
| 2026-08 | -1.66% | -4.38% | -25.46% | $201,177.49 |
...
| 2026-08 | -0.45% | -0.67% | -0.80% | $13,939.85 |
